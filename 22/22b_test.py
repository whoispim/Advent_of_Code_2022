...
def edge_transfer(row, col, direct, sec):
    ...
    if sec == 1:
        if direct == 0:
            ...
            direct = 1
            new_row = 0
            new_col = cube_size[1] - - old_col
    elif sec == 2:
        if direct == 1:
            sec = 5
            direct = 3
            new_row = cube_size[0] - 1
            new_col = cube_size[0] - 1 - old_col
        if direct == 2:
            sec = 6
            direct = 3
            new_row = cube_size[0] - 1
            new_col = cube_size[1] - 1 - old_row
        if direct == 3:
            sec = 1
            direct = 1
            new_row = 0
        ...
        if direct == 0:
            ...
            direct = 1
            new_row = 0
            new_col = cube_size[0] - 1 - old_row
    elif sec == 5:
        if direct == 1:
            sec = 2
            direct = 3
            new_row = cube_size[0] - 1
            new_col = cube_size[1] - 1 - old_col
        elif direct == 2:
            sec = 3
            direct = 3
            new_row = cube_size[0] - 1
...
cube_size = (board.shape[0] // 3, board.shape[1] // 4)
